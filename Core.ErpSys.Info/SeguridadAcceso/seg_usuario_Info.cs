...
namespace Core.ErpSys.Info.SeguridadAcceso
{
    public class seg_usuario_Info
    {
        ...
        public seg_usuario_Info(string _IdUsuario, string _nom_usuario, string _contrasenia, bool _Estado, int? _IdPerfil, bool _Exigir_directivas_seguridad, bool _Exigir_expiracion_contrasenia, bool _usuario_debe_cambiar_contra_inicio_sesion, DateTime _Fecha_expiracion_contrasenia)
        {
