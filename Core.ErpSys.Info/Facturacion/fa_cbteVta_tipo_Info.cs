...
{
    public class fa_cbteVta_tipo_Info
    {
        ...
        public fa_cbteVta_tipo_Info()
        {

        }
        public fa_cbteVta_tipo_Info(int _IdEmpresa,	string _IdCbteVtaTipo,	string _nom_CbteVtaTipo,	Boolean _estado)
        {
